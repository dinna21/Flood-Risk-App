                ...
                <div className="relative" style={{ height: "100%" }}>
                  ...
                  <div className="sticky bottom-0 bg-slate-900 pt-3 pb-4 border-t border-slate-700" style={{ zIndex: 2 }}>
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full font-bold py-4 rounded-xl transition-all duration-200 text-lg shadow-lg text-white bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 hover:shadow-blue-500/40 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:shadow-md disabled:from-slate-600 disabled:to-slate-500 disabled:cursor-not-allowed disabled:shadow-none disabled:translate-y-0 border border-blue-400/30"
                    >
                      {loading ? (
